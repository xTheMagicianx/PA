...
namespace Refaccionaria.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProveedorID,Nombre,Telefono,Email")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProveedorID,Nombre,Telefono,Email")] Proveedor proveedor)
        {
            if (ModelState.IsValid)
            {
